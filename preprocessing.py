...
class Preprocessor(object):
    def __init__(self, segment, config):
        ...
        def crop_start_end(self):
            ...
            self.segment.signals = self.segment.signals[:, newStart * segment.sampling_freq: -newEnd * segment.sampling_freq]
        ...
        def apply_bandpass_time_domain(self):
            ...
            self.segment.signals = mne.filter.filter_data(segment.signals,
                                                          self.segment.sampling_freq,
